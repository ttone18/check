...
ALERT_METADATA = {
    ...
    TYPE_PCIE:      {'priority': P1, 'group': GROUP_HARDWARE, 'title': "节点网卡PCIE链路降级"},
    ...
    TYPE_GPU_CNT:       {'priority': P2, 'group': GROUP_SOFTWARE, 'title': "节点GPU数量与预期不符"},
    TYPE_GPU_TEMP:      {'priority': P2, 'group': GROUP_SOFTWARE, 'title': "节点GPU温度超标(80C-85C)"},
    TYPE_ECC_SOFT:      {'priority': P2, 'group': GROUP_SOFTWARE, 'title': "节点GPU发生ECC错误"},
    TYPE_SMI_CMD_ERROR: {'priority': P2, 'group': GROUP_SOFTWARE, 'title': "节点nvidia-smi命令卡死或报错"},
    TYPE_XID_ERROR:     {'priority': P2, 'group': GROUP_SOFTWARE, 'title': "节点出现严重XID错误 (如XID 79)"},
    TYPE_NVLINK:        {'priority': P2, 'group': GROUP_SOFTWARE, 'title': "节点NVLink链路状态异常"},
